...
- (id)initWithFrame:(CGRect)frame {
    ...
    if (self = [super initWithFrame:frame]) {
        ...
        [self setBackgroundColor:[UIColor getLightGrayColor]];
        ...
        [loadingActivityIndicator_ setColor:[UIColor getPrimaryColor]];
        ...
        [messageLabel_ setTextColor:[UIColor getPrimaryColor]];
        [messageLabel_ setAutoresizingMask:UIViewAutoresizingFlexibleRightMargin];
        [messageLabel_ setFont:[UIFont fontWithName:@"Helvetica-Bold" size:16]];
...
- (void)changeStateOfControl:(MNMBottomPullToRefreshViewState)state offset:(CGFloat)offset {
    ...
    NSString *pullText = [LocalizationHelper getPullTextName];
    NSString *releaseText = [LocalizationHelper getPullTextName];
    NSString *loadText = [LocalizationHelper getPullTextName];
    ...
    switch (state_) {
        ...
        case MNMBottomPullToRefreshViewStateIdle: {
            ...
            [messageLabel_ setText:pullText];
            ...
            [messageLabel_ setText:releaseText];
            ...
            [messageLabel_ setText:loadText];
